                            ...
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p dir="ltr"><span>Hi ${name || 'there'},
                                    ...
                                    Welcome to Kotobamichi! To complete your registration and get full access, please confirm your email address by clicking the button below:</span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div align="center">
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${link}" style="height:37px; v-text-anchor:middle; width:131px;" arcsize="43%"  stroke="f" fillcolor="#9900ff"><w:anchorlock/><center style="color:#FFFFFF;font-family: comic sans ms,sans-serif; "><![endif]-->
                                <a href="${link}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #9900ff; border-radius: 16px;-webkit-border-radius: 16px; -moz-border-radius: 16px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: comic sans ms,sans-serif; font-size: 14px;">
                                  <span style="display:block;padding:10px 20px;line-height:120%;">Confirm Email</span>
                                </a>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p><span>If you did not sign up for an account on Kotobamichi, you can safely ignore this email.</span></p>
                              </div>
