export function render(vars: { name: string; link: string }) {
	...
	const text = `${name ? `${name},\n\n` : ''}We received a request to reset your Kotobamichi password. Please reset your password by visiting this link: ${link}\n\nIf you didn't request this, you can ignore this email.`;
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p dir="ltr"><span>Hi ${name || 'there'},
                                  </span><br><br><span>
                                    We received a request to reset your password. Click the button below to set a new password:</span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div align="center">
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${link}" style="height:37px; v-text-anchor:middle; width:140px;" arcsize="43%"  stroke="f" fillcolor="#ef4444"><w:anchorlock/><center style="color:#FFFFFF;font-family: comic sans ms,sans-serif; "><![endif]-->
                                <a href="${link}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ef4444; border-radius: 16px;-webkit-border-radius: 16px; -moz-border-radius: 16px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: comic sans ms,sans-serif; font-size: 14px;">
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p dir="ltr"><span>If the button doesn't work, copy and paste this URL into your browser:</span><br><span><code>${link}</code></span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p><span>If you did not request a password reset for your Kotobamichi account, you can safely ignore this email.</span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="font-family: comic sans ms,sans-serif; font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                <p><span>Thanks,</span><br><span>The Kotobamichi Team</span></p>
                              </div>
